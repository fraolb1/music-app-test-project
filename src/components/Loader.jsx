...
import { FaMusic } from "react-icons/fa"; // Import an icon library, such as react-icons
...
// Emotion CSS for the loading page
...
// Emotion CSS for the loading animation (customize as needed)
